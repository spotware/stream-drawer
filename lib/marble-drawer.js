...
var Drawer = (function () {
    ...
    Drawer.prototype.initDom = function () {
        this.$streams = $("<ul class=\"streams\"></ul>");
        this.$container.append(this.$streams);
    };
    Drawer.prototype.getContent = function () {
    ...
    Drawer.prototype.draw = function (observersToFill) {
        ...
        observersToFill.forEach(function (observerToFill) {
            _this.drawStream(observerToFill, totalSeconds);
        });
    };
    ...
    Drawer.prototype.drawMarbles = function (observer, totalSeconds) {
        ...
        var $name = $content.find('.stream_name');
        $name.text("" + observer.observableName);
        var $line = $content.find('.stream_line');
        var logs = observer.logsStamps;
        logs.forEach(function (log) {
            var position = Math.floor((log.timeStamp - _this.initialTime) / 1000 * 10);
            var relativeTime = Math.floor(position / totalSeconds * 100);
            var $marble = $("<a class=\"stream_line__marble\" title=\"" + log.data + "\"></a>");
...
/***/ }
/******/ ]);
//# sourceMappingURL=marble-drawer.js.map